...
def convert_audio_format(input_folder, output_folder, input_format, output_format, delete_input_after_conversion=False):
    ...
    for input_file in input_files:
        # Crear el nombre de archivo para el audio de salida
...
if __name__ == "__main__":
    ...
    input_format = "mp3"   # Reemplazar con el formato de entrada deseado (ejemplo: "mp3", "wav", etc.)
    output_format = "ogg"  # Reemplazar con el formato de salida deseado (ejemplo: "ogg", "flac", etc.)
    ...
    convert_audio_format(input_folder_path, output_folder_path, input_format, output_format, delete_input_after_conversion=delete_input_option)